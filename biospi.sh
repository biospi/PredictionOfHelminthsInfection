...
nohup python3 run_thesis.py --output-dir /mnt/storage/scratch/axel/thesis3 --delmas-dir /mnt/storage/scratch/axel/dataset4_mrnn_7day --cedara-dir /mnt/storage/scratch/axel/dataset6_mrnn_7day > log_.txt &