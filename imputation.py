...
def load_farm_data(fname, n_job, n_top_traces=0, enable_anscombe=False, enable_log_anscombe=False, enable_remove_zeros=False, window=False):
    ...
    for result in tqdm(results):
        ...
        if enable_log_anscombe:
            ...
            #assert np.array_equal(np.round(activity_o), activity_reverse, equal_nan=True), "Inverse ascombe failed!"
...
if __name__ == '__main__':
  ...
  parser.add_argument('--thresh_daytime', type=str, default='100')
  parser.add_argument('--thresh_nan_ratio', type=str, default='80')
