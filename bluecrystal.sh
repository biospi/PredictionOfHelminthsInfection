...
cmds=('ml.py --dataset-folder /user/work/fo18103/cedara/datasetraw_none_7day --n-imputed-days -1 --n-activity-days 1 --study-id cedara --preprocessing-steps LINEAR --cv RepeatedKFold --classifiers linear --classifiers rbf --class-healthy-label 1To1 --class-unhealthy-label 1To2 --output-dir /user/work/fo18103/thesis/main_experiment/cedara_RepeatedKFold_-1_1_LINEAR_linear_rbf/1To1__1To2' 'ml.py --dataset-folder /user/work/fo18103/delmas/datasetraw_none_7day --n-imputed-days -1 --n-activity-days 1 --study-id delmas --preprocessing-steps LINEAR --cv RepeatedKFold --classifiers linear --classifiers rbf --class-healthy-label 1To1 --class-unhealthy-label 1To2 --output-dir /user/work/fo18103/thesis/main_experiment/delmas_RepeatedKFold_-1_1_LINEAR_linear_rbf/1To1__1To2')
# Execute code
